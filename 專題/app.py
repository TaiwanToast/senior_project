...
# ---------------------------
# 請填入你的 OpenAI API 金鑰
api_key = "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"
...
4. 推薦每項商品都需包含以下資訊：
    ...
    - 價格（新台幣，數字格式）
    - 推薦語（簡短有說服力）
    - 商品圖片網址（PChome、Momo、蝦皮等）
    - 連結（商品連結網址，PChome、Momo、蝦皮等）
...
圖片：https://shopping.pchome.com.tw/xxx.jpg
連結：https://24h.pchome.com.tw/prod/xxx
---
